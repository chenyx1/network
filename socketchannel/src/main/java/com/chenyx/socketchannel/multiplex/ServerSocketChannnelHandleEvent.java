...
/**
 * @author ：chenyx
 * @description 多路复用服务端消息处理
 * @date ：2021/6/30 9:39
 */
public class ServerSocketChannnelHandleEvent extends BaseHandEvent {
    ...
    public void readEvent(SocketChannel socketChannel) throws IOException {
        ...
        System.out.println("server received:" + socketChannel.getRemoteAddress() + " message,content:" + msgBuilder.toString());
        //重置
        buffer.clear();
